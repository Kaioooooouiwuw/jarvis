"""
Website Elytron — Projeto gerado pelo Jarvis
...
app = FastAPI(title="Website Elytron", description="Projeto gerado pelo Jarvis")
...
@app.get("/")
async def root():
    return {"msg": "API Website Elytron funcionando!", "docs": "/docs"}
